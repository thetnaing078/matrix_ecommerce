...
/* harmony import */ var _Config_MediaConfig__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Config/MediaConfig */ "./platform/core/media/resources/assets/js/App/Config/MediaConfig.js");
/* harmony import */ var _MediaService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MediaService */ "./platform/core/media/resources/assets/js/App/Services/MediaService.js");
/* harmony import */ var _MessageService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MessageService */ "./platform/core/media/resources/assets/js/App/Services/MessageService.js");
/* harmony import */ var _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Helpers/Helpers */ "./platform/core/media/resources/assets/js/App/Helpers/Helpers.js");
...
var DownloadService = /*#__PURE__*/function () {
  function DownloadService() {
    ...
    this.MediaService = new _MediaService__WEBPACK_IMPORTED_MODULE_2__.MediaService();
    $('body').on('shown.bs.modal', '#modal_download_url', function (event) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
                        ...
                        case 0:
                          ...
                          return new Promise(function (resolve) {
                            $.ajax({
                              ...
                              type: 'POST',
                              data: {
                                folderId: _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_4__.Helpers.getRequestParams().folder_id,
                                url: url
                              },
                              dataType: 'json',
                              success: function success(res) {
                              ...
                              error: function error(data) {
                                _MessageService__WEBPACK_IMPORTED_MODULE_3__.MessageService.handleError(data);
                              }
                            });
                          });
              ...
              case 20:
                _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_4__.Helpers.resetPagination();

                _self.MediaService.getMedia(true);

                if (!hasError) {
                  DownloadService.closeModal();
                  _MessageService__WEBPACK_IMPORTED_MODULE_3__.MessageService.showMessage('success', RV_MEDIA_CONFIG.translations.message.success_header);
                }
